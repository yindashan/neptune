...
class RegisterForm(forms.Form):
    ...
    usertype=forms.CharField(label=_(u"权限"),max_length=30,widget=forms.TextInput(attrs={'size': 20,}))
    department=forms.CharField(label=_(u"部门"),max_length=30,widget=forms.TextInput(attrs={'size': 20,}))
    phone=forms.CharField(label=_(u"联系方式"),max_length=30,widget=forms.TextInput(attrs={'size': 20,}))
